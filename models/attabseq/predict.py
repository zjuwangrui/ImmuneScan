...
if __name__ == "__main__":
    ...
    dir_input = ('/apdcephfs/private_cassiejin/transformerABI3/data')
    antibodies = np.load(dir_input+'/1101pssm/'+'ab.npy',allow_pickle=True)
    antibodies_mut = np.load(dir_input+'/1101pssm/'+'ab_mut.npy',allow_pickle=True)
    antigens = np.load(dir_input+'/1101pssm/'+'ag.npy',allow_pickle=True)
    antigens_mut = np.load(dir_input+'/1101pssm/'+'ag_mut.npy',allow_pickle=True)
    interactions = np.load(dir_input+'/1101pssm/'+'Y.npy',allow_pickle=True)
    ...
    model.load_state_dict(torch.load("/apdcephfs/private_cassiejin/transformerABI3/output/model/model_1"))
    model.to(device)
    #if is_distributed:
    ...
    """Output files."""
    file_PCCS = '/apdcephfs/private_cassiejin/transformerABI4/output/result/RECORD.txt'
    file_model = '/apdcephfs/private_cassiejin/transformerABI4/output/model/model'
